...
import { Stack, Avatar, AvatarGroup, BottomNavigationAction } from '@mui/material'


const MuiAvatar = () => {
  return (
    <>
    <h2>Tutorial 28 Avatar</h2>
    <Stack spacing={4}>
        ...
        <Stack direction='row' spacing={1}>
            ...
            <Avatar src='https://randomuser.me/api/portraits/men/51.jpg' alt='Joe Doe'/>
            </AvatarGroup>
        </Stack>
        <Stack direction='row' spacing={1}>
